...
public class ImageDropTargetDemo extends JPanel
	...
	private static final long serialVersionUID = 2594099142796049667L;
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("HACK #61 Image DropTarget Demo");
    ...
    public void drop(DropTargetDropEvent dtde) {
        ...
        try {
            ...
            if (trans.isDataFlavorSupported(DataFlavor.imageFlavor)) {
                ...
                Image img = (Image) method.invoke(null, in); /* JDK1.5 */
                showImageInNewFrame(img);
                gotData = true;
            }
        } catch (Exception e) {
