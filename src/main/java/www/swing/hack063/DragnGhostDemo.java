...
public class DragnGhostDemo extends JFrame
{
    ...
    public DragnGhostDemo()
    {
        ...
        label.addMouseListener(pictureAdapter = new GhostPictureAdapter(glassPane, "new_sale", "./images063/new_sale.png"));
        ...
        label.addMouseListener(pictureAdapter = new GhostPictureAdapter(glassPane, "view_sale", "./images063/view_sale.png"));
        pictureAdapter.addGhostDropListener(listener);
        label.addMouseMotionListener(new GhostMotionAdapter(glassPane));

        box.add(label = UIHelper.createLabel("Quit", "quit"));
        label.addMouseListener(pictureAdapter = new GhostPictureAdapter(glassPane, "quit", "./images063/quit.png"));
        pictureAdapter.addGhostDropListener(listener);
        label.addMouseMotionListener(new GhostMotionAdapter(glassPane));
