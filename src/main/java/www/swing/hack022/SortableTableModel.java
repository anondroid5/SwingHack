...
public class SortableTableModel implements TableModel, TableModelListener {
    ...
    protected void resort() {
        ...
        for (int i=0; i<delegatedModel.getRowCount(); i++) {
            // SortingDelegate に ソート対象となるオブジェクトを登録する
            SortingDelegate sd =
    ...
    // to value 2 in
    class SortingDelegateComparator implements Comparator<SortingDelegate> {
        Comparator comp;
        ...
        public int compare(SortingDelegate sd1, SortingDelegate sd2) {
            Object v1 = sd1.value;
            Object v2 = sd2.value;
            if (comp != null) {
                ...
                throw new IllegalArgumentException(
                    "Can't compare objects for sorting");
            }
        }
    }
